---
tags: [knowledge, familylink, architecture, nextjs, supabase, multi-tenant]
...
# FamilyLink Architecture Decisions
...
> Proiect: [[FamilyLink Platform]] · scope contract: [[FamilyLink Faza 1 MVP]] · subprocessors EU: [[FamilyLink Subprocessors EU Audit]] · pricing model: [[FamilyLink Pricing T1-T4]] · GDPR: [[FamilyLink GDPR Approach]]
